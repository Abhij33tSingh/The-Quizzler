  ...
  const [state, setState] = useState('start')  
    const {
      ...
      const addAquestion = (e) => {
        ...
        const AnswerInputClasses = !AnswerIsValid() && AnswerInputTouched ? "invalid" : "";
        const option1InputClasses = !option1IsValid && option1InputTouched ? "invalid" : "";
        const option2InputClasses = !option2IsValid && option2InputTouched ? "invalid" : "";
        const option3InputClasses = !option3IsValid && option3InputTouched ? "invalid" : "";
        const option4InputClasses = !option4IsValid && option4InputTouched ? "invalid" : "";
        const formIsValid = QuestionIsValid && AnswerIsValid() && option1IsValid && option2IsValid && option3IsValid &&option4IsValid;
    return (
        <div>
          {state === 'start' &&
            (<div>
